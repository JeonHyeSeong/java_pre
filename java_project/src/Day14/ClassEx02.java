...
public class ClassEx02 {
	...
	public static void main(String[] args) {
		/* static이 붙은 멤버변수 / 메서드를 클래스 멤버변수/메서드라고 한다.
		/* static이 안붙은 멤버변수 / 메서드를 객체(인스턴스) 멤버변수/메서드라고 한다.
		 ...
		 * - final 멤버변수 : 상수(수정할 수 없는 값)
		 * - final 멤버메서드 : 오버라이딩(재정의) 할 수 없다.
