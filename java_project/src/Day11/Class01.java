...
public class Class01 { // 파일명과 클래스 명이 같을경우에만 public 가능.
// 멤버변수 선언 위치
	public static void main(String[] args) {
		 ...
		 * 
		 * - 클래스에 public을 붙일 수 있는건 파일명 = 클래스명 같을 경우에만 가능
		 * - 멤버변수와 멤버메서드 public은 문제없이 사용가능.
		 * - private : 멤버변수나 멤버메서드는 다른 클래스에서 사용할 수 없다.
		 * - 일반적으로 멤버변수는 private, 메서드는 public으로 선언한다.
		 * - private으로 선언된 멤버변수는 getter/setter 메서드를 만들어서 해당 변수에 
		 * 접근할 수 있도록 한다.
		 * */
		point p = new point();
		p.print();
